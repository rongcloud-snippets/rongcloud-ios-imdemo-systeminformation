...
- (void)onSelectedTableRow:(RCConversationModelType)conversationModelType
    ...
    if (model.conversationModelType == RC_CONVERSATION_MODEL_TYPE_COLLECTION) {
        ...
        RCSConversationListViewController *conversationlist = [[RCSConversationListViewController alloc] initWithDisplayConversationTypes:@[@(ConversationType_SYSTEM)] collectionConversationType:nil];
        conversationlist.isEnteredToCollectionViewController = YES;
